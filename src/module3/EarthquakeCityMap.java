...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {
		...
		fill(red);
		ellipse(40, FirstLine, 10, 10);
		fill(yellow);
		ellipse(40, SecondLine, 5, 5);
		fill(blue);
		ellipse(40, ThirdLine, 2, 2);
		fill(0);
		text("5.0+ Magnitude", 60, FirstLine + 2);
		text("4.0+ Magnitude", 60, SecondLine + 2);
		text("Below 4.0", 60, ThirdLine + 2);
